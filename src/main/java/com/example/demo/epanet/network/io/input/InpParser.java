...
package com.example.demo.epanet.network.io.input;


import com.example.demo.epanet.Constants;
import com.example.demo.epanet.network.FieldsMap;
import com.example.demo.epanet.network.FieldsMap.Type;
import com.example.demo.epanet.network.Network;
import com.example.demo.epanet.network.PropertiesMap;
import com.example.demo.epanet.network.io.Keywords;
import com.example.demo.epanet.network.structures.*;
import com.example.demo.epanet.network.structures.Control.ControlType;
import com.example.demo.epanet.network.structures.Link.LinkType;
import com.example.demo.epanet.network.structures.Link.StatType;
import com.example.demo.epanet.util.ENException;
import com.example.demo.epanet.util.ENLevels;
import com.example.demo.epanet.util.Utilities;
